...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_00.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_01.png
    :align: center
...
.. |Chapter01_02| image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_02.png
.. |Chapter01_03| image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_03.png

PCF8574 module pin and LCD1602 pin are corresponding to each other and connected with each other:

.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_04.png
    :align: center
...
.. |Chapter01_05| image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_05.png
.. |Chapter01_06| image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_06.png

Code
==========================================

Move the program folder "Freenove_LCD_Module/Freenove_LCD_Module_for_ESP32/Python/Python_Codes" to disk(D) in advance with the path of "D:/Micropython_Codes".

Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "1.1_I2C_LCD1602". Select "I2C_LCD.py"and "LCD_API.py", right click your mouse to select "Upload to /", wait for "I2C_LCD.py" and"LCD_API.py" to be uploaded to ESP32-WROVER and then double click "I2C_LCD1602.py". 

1.1_I2C_LCD1602
-----------------------------------------

.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_07.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_08.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_09.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_10.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_11.png
    :align: center

Uploading code to ESP32
----------------------------------------

As shown in the following illustration, Select "I2C_LCD.py"and"LCD_API.py"and"I2C_LCD1602.py", right click your mouse to select "Upload to /" to upload code to ESP32.

.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_12.png
    :align: center

Upload boot.py in the same way.

.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_13.png
    :align: center

Press the reset key of ESP32 and you can see LCD1602 displays some characters. 

.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_14.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_15.png
    :align: center
...
.. literalinclude:: ../../../../freenove_Kit/Freenove_LCD_Module_for_ESP32/Python/Python_Codes/1.1_IIC_LCD1602/IIC_LCD1602.py
    :linenos:
    :language: python
    :dedent:
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_16.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_17.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_18.png
    :align: center
...
.. image:: ../../_static/imgs/ESP32/Python/1_I2C_LCD1602/Chapter01_19.png
    :align: center
